...
public class ClassExtends {
     ...
     *
     * <p>К примеру у нас есть классы Домашняя кошка и Дикий Медведь. Кошка умеет высоко прыгать, просить еду у хозяина. Медведь умеет спать всю зиму.
     * <p>У каждого из этих классов будут свои методы. У кошки просить еду, У медведя впасть в спячку.
     * <p>При этом у них есть много одинаковых действий: Бежать, кушать, спать.
     * <p>Чтобы нам не прописывать в каждом классе эти методы их нужно наследование мы можем создать 1 класс "Животные". Определить ему методы Бежать, кушать, спать
